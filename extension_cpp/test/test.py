...
# If codetr_cpp is there, check what ops it has
if hasattr(torch.ops, 'codetr_cpp'):
    print(dir(torch.ops.codetr_cpp))
...
output = torch.ops.codetr_cpp.ms_deform_attn_forward(*args)
...
torch.library.opcheck(torch.ops.codetr_cpp.ms_deform_attn_forward.default, args)